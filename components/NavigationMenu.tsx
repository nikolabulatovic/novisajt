...
const stageLabels: Record<Stage, string> = {
  ...
  'da-li-bi-voleo': 'Da li bi voleo?',
  'prepoznavanje-nepravde': 'Prepoznavanje nepravde',
  'breaking-question': 'Prelomno pitanje',
  'ostani-komforan': 'Ostani komforan',
  'apatican-stav': 'Apatičan stav',
  ...
  'accepting-self-ownership': 'Sopstveno vlasništvo',
  ...
  'vec-veganski': 'Već veganski',
  'solution-know': 'Da li znaš da je moguće?',
  'vegan-diet-health': 'Veganska ishrana i zdravlje',
  'nije-ubedilo-resursi': 'Dodatni resursi',
  'solution-choice': 'Biranje suprotno uverenju',
  'kontradiktornost-je': 'Kontradiktornost',
  'nisi-iskren': 'Nisi iskren',
  'align-behaviour': 'Usaglašavanje ponašanja',
  'vracanje-na-odgovore': 'Vraćanje na odgovore',
  'ponovo-na-odgovore': 'Ponovo na odgovore',
  'ne-drzis-se': 'Ne držiš se',
