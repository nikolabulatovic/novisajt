...
const stageLabels: Record<Stage, string> = {
  ...
  'spasa-revelation-part1': 'Ostali prasići',
  facts: 'Činjenice',
  'spasa-revelation-part2': 'Koren problema',
  'spasa-revelation-part3': 'Gde se koriste',
  'spasa-revelation-part4': 'Da žive svoj život',
  'spasa-revelation-part5': 'Resurs i kontrola',
  'spasa-revelation-part6': 'U životu dok donosi prihod',
  'spasa-revelation-part7': 'Biološka dominacija',
...
const stageOrder: Stage[] = [
  ...
  'spasa-revelation-part5',
  'spasa-revelation-part6',
  'spasa-revelation-part7',
  'facts',
  'animal-exploitation',
  'domestication',
  'moral-consistency',
