  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md rounded-3xl border border-white/10 bg-[#101014]/95 px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,0.55)] ring-1 ring-white/5 sm:px-8 sm:py-10"
      >
