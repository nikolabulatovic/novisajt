...
const stageLabelKeys: Record<Stage, string> = {
  ...
  [StageId.ReturnWhenReady]: 'stages.returnWhenReady',
...
const stageNavItems: StageNavItem[] = [
  ...
  { stage: StageId.ActResponsibly, depth: 3 },
  { stage: StageId.NotWhoYouThink, depth: 4 },
  { stage: StageId.ReturnWhenReady, depth: 3 },
