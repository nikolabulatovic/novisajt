...
const stageLabelKeys: Record<Stage, string> = {
  ...
  [StageId.StillWantToKnow]: 'stages.stillWantToKnow',
  ...
  [StageId.Excuse]: 'stages.excuse',
  [StageId.DoubleStandard]: 'stages.doubleStandard',
  [StageId.NotThreatened]: 'stages.notThreatened',
  [StageId.YouAreResponsible]: 'stages.youAreResponsible',
  [StageId.ActResponsibly]: 'stages.actResponsibly',
  [StageId.NotWhoYouThink]: 'stages.notWhoYouThink',
...
const stageNavItems: StageNavItem[] = [
  ...
  { stage: StageId.StillWantToKnow, depth: 1 },
  ...
  { stage: StageId.Excuse, depth: 1 },
  { stage: StageId.NotThreatened, depth: 2 },
  { stage: StageId.DoubleStandard, depth: 1 },
  { stage: StageId.YouAreResponsible, depth: 2 },
  { stage: StageId.AvoidingResponsibility, depth: 3 },
  { stage: StageId.ActResponsibly, depth: 2 },
