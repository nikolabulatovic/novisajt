...
const genderCardClassName =
  'group relative flex flex-col items-center justify-center gap-3 overflow-hidden rounded-2xl border border-gray-800/50 bg-gray-900/70 px-6 py-6 sm:px-8 sm:py-7 transition-all duration-300 hover:scale-[1.02] hover:border-gray-700/50 hover:bg-gray-800/80 cursor-pointer';
...
export default function RedPillIntro() {
  ...
  const handleChoice = (
    ...
    scheduleAnswerChoiceExit(
      ...
      () => {
        completeStage(StageId.Intro, resolveAnswer(choice));
      },
    );
  };
