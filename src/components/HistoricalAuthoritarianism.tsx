...
interface HistoricalAuthoritarianismProps {
  onComplete: () => void;
}

export default function HistoricalAuthoritarianism({
  onComplete,
}: HistoricalAuthoritarianismProps) {
  const t = useTranslations('HistoricalAuthoritarianism');
    ...
    <div className="relative w-full min-h-screen">
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/images/nacizam.jpg')" }}
        />
